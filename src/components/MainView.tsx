...
export type ColumnConfig = {
  id: string
  label: string
  getValue: (position: AssetPosition) => string | number | React.ReactNode
  renderCell: (position: AssetPosition) => React.ReactNode
}
          ...
          setAccountState((prevAccountState?: AccountState) => {
            ...
            if (positionsChanged) {
              if (prevAccountState != null && newAccountState != null) {
                ...
                const allPositionChanges: Record<string, Record<string, { from: string | number; to: string | number }>> = {}
                const newPositions: Record<string, { size: string; value: string; pnl: string }> = {}
